...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Curriculum', to: '/curriculum', icon: BookOpen, soon: true },
      { label: 'Scheme of Work', to: '/schemes', icon: NotebookPen, soon: true },
      { label: 'Lesson Plans', to: '/lessons', icon: Presentation, soon: true },
