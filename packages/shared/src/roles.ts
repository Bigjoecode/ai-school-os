...
export const SYSTEM_ROLES: SystemRoleDefinition[] = [
  ...
  },
  {
    ...
    permissions: [...readCore, 'academics.manage', 'students.manage', 'curriculum.read', 'curriculum.manage', 'lessons.read', 'lessons.manage', 'assessment.read', 'assessment.manage', 'results.read', 'results.enter', 'results.publish', 'timetable.read', 'timetable.manage', 'attendance.read', 'attendance.take', 'attendance.manage', 'ai.use'],
  },
  {
    key: 'academic_coordinator',
    name: 'Academic Coordinator',
    description: 'Owns curriculum, schemes, timetable and assessment.',
    permissions: [...readCore, 'academics.manage', 'curriculum.read', 'curriculum.manage', 'lessons.read', 'lessons.manage', 'assessment.read', 'assessment.manage', 'results.read', 'results.enter', 'results.publish', 'timetable.read', 'timetable.manage', 'attendance.read', 'attendance.take', 'ai.use'],
  },
  {
    key: 'teacher',
    name: 'Teacher',
    description: 'Teaches classes, records attendance and results.',
    permissions: ['school.read', 'academics.read', 'students.read', 'guardians.read', 'curriculum.read', 'lessons.read', 'lessons.manage', 'assessment.read', 'assessment.manage', 'results.read', 'results.enter', 'timetable.read', 'attendance.read', 'attendance.take', 'ai.use'],
  },
  {
    key: 'accountant',
    name: 'Accountant',
  ...
  },
  {
    ...
    permissions: ['school.read', 'staff.read', 'staff.manage', 'timetable.read', 'attendance.read', 'attendance.manage', 'ai.use'],
  },
  {
    key: 'receptionist',
    name: 'Receptionist',
    description: 'Front desk: visitors, enquiries and admissions.',
    permissions: ['school.read', 'students.read', 'guardians.read', 'timetable.read', 'attendance.read'],
  },
  {
    key: 'librarian',
    name: 'Librarian',
    description: 'Runs the library.',
    permissions: ['school.read', 'students.read', 'staff.read', 'timetable.read'],
  },
  {
    key: 'transport_manager',
    name: 'Transport Manager',
    description: 'Runs routes and vehicles.',
    permissions: ['school.read', 'students.read', 'timetable.read'],
  },
  {
    key: 'hostel_manager',
    name: 'Hostel Manager',
